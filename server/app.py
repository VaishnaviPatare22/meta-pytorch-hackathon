...
# --- FIXED: Added '4' to tell Streamlit to create 4 equal columns ---
...
# --- FIXED: Added '' to make the left side wider than the right side ---
...
with col_left:
    ...
    # Styling the status column for better visibility
    ...
    st.dataframe(df_display.style.map(style_status, subset=['Status']), width="stretch")# Interactive Controls
with col_right:
